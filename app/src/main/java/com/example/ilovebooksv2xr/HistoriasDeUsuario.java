...
public class HistoriasDeUsuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_historias_de_usuario);
        ...
        mishistorias.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent per = new Intent(HistoriasDeUsuario.this,EditarLibro.class);
                startActivity(per);
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(HistoriasDeUsuario.this, MainActivity.class);
        ...
        BCrearHistoria.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HistoriasDeUsuario.this, CrearLibro.class);
                startActivity(intent);
            }
        });
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot objSnaptshot : snapshot.getChildren()){
                    ...
                    if(h.getAutor().equals(MainActivity.LlaveUsuario)){
                        listhistorias.add(h);
                        arrayAdapterHistorias = new HistoriasAdapter(HistoriasDeUsuario.this, listhistorias);
